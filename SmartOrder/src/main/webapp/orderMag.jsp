...
<body>
    ...
    <div class="container">
        <!-- 검색 폼 -->
        <form id="frmOrderSearch" method="post" action="orderMag.jsp" style="text-align: center; margin: 0 auto; padding: 20px;">
            <label>주문일자</label>
        ...
        <!-- 주문 목록 테이블 -->
        <table class="order-table" border="1" style="width: 75%; text-align: center; margin: 0 auto;">
            <thead>
                <tr>
                    <th>주문번호</th>
                    <th>상품명</th>
